 ...
 *
 * Charger Control driver for pm-8921-charger
 *
...
int max_custom_current = MAX_CUSTOM_CURRENT;	
int min_custom_current = MIN_CUSTOM_CURRENT;	
...
MODULE_DESCRIPTION("pm-8921 Charger control driver");
